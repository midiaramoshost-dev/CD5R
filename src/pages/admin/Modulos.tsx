...
const modulosIniciais: Modulo[] = [
  ...
  {
    id: "chamada_eletronica",
    nome: "Chamada Eletrônica (Faltas)",
    descricao: "Lista de chamada digital com notificação a responsáveis (SMS/WhatsApp/Telegram)",
    icone: Calendar,
    categoria: "academico",
    planoMinimo: "Free",
    ativo: true,
  },
  {
    ...
    descricao: "Geração e emissão de histórico escolar oficial dos alunos",
    icone: FileText,
    categoria: "academico",
    planoMinimo: "Start",
    ativo: true,
  ...
  {
    id: "contratos_massa",
    nome: "Contratos em Massa",
    descricao: "Geração e envio de contratos para múltiplos alunos de uma só vez",
    icone: FileText,
    categoria: "academico",
    planoMinimo: "Pro",
    ativo: true,
  ...
  {
    id: "rematriculas_massa",
    nome: "Rematrículas em Massa",
    descricao: "Processo de rematrícula em lote para o ano letivo seguinte",
    icone: GraduationCap,
    categoria: "academico",
    planoMinimo: "Pro",
    ativo: true,
